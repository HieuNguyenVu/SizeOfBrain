...
constructor(x,y){
  ...
  this.spritePike=Nakama.trapGroup.create(x+1000,1120,'Foundation','PikeWhite.png');
  ...
  this.spritePike2=Nakama.trapGroup.create(x+700,1120,'Foundation','PikeWhiteShort.png');
