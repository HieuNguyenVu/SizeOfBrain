class FoundationTrap9{
  constructor(x,y){
    ...
    this.spritePike1=Nakama.trapGroup.create(x+200,1150,'Foundation','PikeBlack.png');
    this.spritePike2=Nakama.trapGroup.create(x+200,950,'Foundation','PikeWhite.png');
    ...
    this.text1 = Nakama.game.add.text(x+100, 600, "Giáo trắng an toàn", { font: "60px Arial Black", fill: "#c51b7d" });
